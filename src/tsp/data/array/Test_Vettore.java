...
public class Test_Vettore {
	...
	public static void main(String[] args) {
		...
		LKIntesifier intensifier = new LKIntesifier(manager);
		
		intensifier.setParam(20, 15, 5, 15, 76);
		
		//TSSolution solution = new TSSolution(cities);
		
		ArraySolution solution=new ArraySolution(cities,manager);
		...
		ArraySolution best_sol= (ArraySolution)intensifier.improve(solution);
